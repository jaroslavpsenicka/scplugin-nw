...
public class SmartCaseTasksImpl extends ASTWrapperPsiElement implements SmartCaseTasks {

  public SmartCaseTasksImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<SmartCaseTask> getTaskList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SmartCaseTask.class);
  }
