...
public class SmartCaseTransitionsImpl extends ASTWrapperPsiElement implements SmartCaseTransitions {

  public SmartCaseTransitionsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<SmartCaseTransition> getTransitionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SmartCaseTransition.class);
  }
